...
def show_all_students_info(list_of_students = []):
    ...
    for student in list_of_students:
        show_student_info(student.name, student.section, student.spanish_grade, student.english_grade, student.social_studies_grade, student.science_grade, student.average_grade)
...
def show_top_3_students(sorted_students_list=[]):
    ...
    print("└────────────────────────────────────────────────────────┘")
    print('\nPrimer lugar')
    show_student_info(sorted_students_list[0].name, sorted_students_list[0].section, sorted_students_list[0].spanish_grade, sorted_students_list[0].english_grade, sorted_students_list[0].social_studies_grade, sorted_students_list[0].science_grade, sorted_students_list[0].average_grade) 
    print('\nSegundo lugar')
    show_student_info(sorted_students_list[1].name, sorted_students_list[1].section, sorted_students_list[1].spanish_grade, sorted_students_list[1].english_grade, sorted_students_list[1].social_studies_grade, sorted_students_list[1].science_grade, sorted_students_list[1].average_grade) 
    print('\nTercer lugar')
    show_student_info(sorted_students_list[2].name, sorted_students_list[2].section, sorted_students_list[2].spanish_grade, sorted_students_list[2].english_grade, sorted_students_list[2].social_studies_grade, sorted_students_list[2].science_grade, sorted_students_list[2].average_grade) 
